...
├── src/
│   ├── ai/
│   │   ├── flows/            # Core Genkit flows for AI logic
│   │   ├── tools/            # Tools the AI can call (e.g., to modify the graph)
│   │   ├── dev.ts            # Genkit development server entrypoint
│   │   └── genkit.ts         # Genkit configuration and initialization
│   ├── app/
│   │   ├── auth/             # Authentication page
│   │   ├── graph/[graphId]/  # The main graph view page
│   │   ├── home/             # User's dashboard with a list of their graphs
│   │   ├── globals.css       # Global styles and theme variables
│   │   └── layout.tsx        # Root layout
│   ├── components/
│   │   ├── ideamesh/         # App-specific components (GraphView, ControlPanel, etc.)
│   │   └── ui/               # Reusable ShadCN UI components (Button, Card, etc.)
│   ├── hooks/
│   │   ├── use-auth.tsx      # Manages user authentication state
